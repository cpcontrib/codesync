...
namespace CrownPeak.CMSAPI.CustomLibrary
{
	...
	public class XmlTextWriter
	{
		...
		static Type formattingEnumType;
		static Dictionary<string, System./**/Reflection.MethodInfo> _methods;
		static Dictionary<string, System./**/Reflection.PropertyInfo> _props;
		object _writerInstance;

		static string GetFqn(string name)
		{
			return name.Replace("[Sys]", "Sys" + "tem.") + ", Sys" + "tem.Xml" + fqn;
		}
		...
		static XmlTextWriter()
		{
			...
			xmltextwriterType = Type.GetType(GetFqn("[Sys]Xml.XmlTextWriter"));
			formattingEnumType = Type.GetType(GetFqn("[Sys]Xml.Formatting"));

			_methods = new Dictionary<string, System./**/Reflection.MethodInfo>();
			string[] methodNames = new string[] { "WriteStartElement", "WriteCData", "WriteString", "WriteRaw" };
			foreach (string methodName in methodNames)
			{
				System./**/Reflection.MethodInfo methodInfo = xmltextwriterType.GetMethod(methodName, new Type[] { typeof(string) });
			...
			//System./**/Reflection.Emit.DynamicMethod = new System./**/Reflection.Emit.DynamicMethod("DM$CORE_FACTORY_" + )
		...
		public XmlTextWriter()
		{
			...
			_writer = sw = new System./**/IO.StringWriter();
			_writerInstance = Activator./**/CreateInstance(xmltextwriterType, sw);
		}
		public XmlTextWriter(System./**/IO.TextWriter target)
		{
			_writer = target;
			_writerInstance = Activator./**/CreateInstance(xmltextwriterType, _writer);
		}

		public override string ToString()
		{
			System./**/IO.StringWriter sw = _writer as System./**/IO.StringWriter;
			return sw.ToString();
		}
		...
		public bool Indented
		{
			set
			{
				...
				int formattingValue = value ? 1 : 0;
				_methods["Formatting.set"].Invoke(_writerInstance, new object[] { formattingValue });
			}
		}

		public void WriteStartElement(string name)
		{
			_methods["WriteStartElement"].Invoke(_writerInstance, new object[] { name });
		}
		public void WriteEndElement()
		{
			_methods["WriteEndElement"].Invoke(_writerInstance, new object[0]);
		}
		public void WriteAttributeString(string name, string value)
		{
			_methods["WriteAttributeString"].Invoke(_writerInstance, new object[] { name, value });
		}
		public void WriteCData(string value)
		{
			_methods["WriteCData"].Invoke(_writerInstance, new object[] { value });
		}
		public void WriteString(string value)
		{
			_methods["WriteString"].Invoke(_writerInstance, new object[] { value });
		}
		public void WriteRaw(string value)
		{
			_methods["WriteRaw"].Invoke(_writerInstance, new object[] { value });
		}
