...
<%//This plugin uses PostSaveContext as its context class type
	...
	foreach (string basepath in Paths)
	{
		...
		WriteFolderAndChildren(folder, true, sb);
	...
	if (string.IsNullOrWhiteSpace(asset["mail_to"]) == false)
	{
		...
		msg.Attachments.Add(CreateAttachmentFromText(sb.ToString()));
...
<script runat="server" data-cpcode="true">
	...
	void WriteFolderAndChildren(Asset folder, bool deep, System.Text.StringBuilder sb)
	{
	...
	static void WriteFileNode(Asset asset, System.Text.StringBuilder sb)
	{
		Out.DebugWriteLine("writing {0}", asset.AssetPath);
		sb.AppendFormat("<codeFile name=\"{0}\">", asset.AssetPath);
	...
	static System
		.Net
		.Mail.Attachment CreateAttachmentFromText(string value, string contentType = "text/plain")
	{
		System
		...
		System
			.Net.Mail.Attachment attachment = new System.
				Net.Mail.Attachment(ms, "codelibrary.xml", "text/xml");
